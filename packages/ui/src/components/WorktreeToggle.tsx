...
const MODES = [
  { key: 'local' as const, label: 'Local', color: 'blue', description: 'Work directly in the repository' },
  { key: 'worktree' as const, label: 'Worktree', color: 'purple', description: 'Work in an isolated git worktree' }
]
