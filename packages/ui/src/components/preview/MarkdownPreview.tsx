    ...
    <div className="flex-1 overflow-y-auto p-6">
      <div className="max-w-none text-gray-200 text-sm leading-relaxed">
        <ReactMarkdown
          ...
          components={{
            h1: ({ children }) => <h1 className="text-2xl font-bold text-gray-100 mt-6 mb-3 first:mt-0">{children}</h1>,
            ...
            h4: ({ children }) => <h4 className="text-base font-semibold text-gray-200 mt-3 mb-1">{children}</h4>,
            p: ({ children }) => <p className="mb-3">{children}</p>,
            ul: ({ children }) => <ul className="list-disc pl-5 mb-3 space-y-1">{children}</ul>,
            ol: ({ children }) => <ol className="list-decimal pl-5 mb-3 space-y-1">{children}</ol>,
            li: ({ children }) => <li className="text-gray-300">{children}</li>,
            blockquote: ({ children }) => <blockquote className="border-l-2 border-gray-600 pl-4 my-3 text-gray-400 italic">{children}</blockquote>,
            table: ({ children }) => <div className="overflow-x-auto mb-3"><table className="min-w-full text-sm border-collapse">{children}</table></div>,
            th: ({ children }) => <th className="border border-gray-700 px-3 py-1.5 bg-[#1a1a1a] text-left font-semibold text-gray-200">{children}</th>,
