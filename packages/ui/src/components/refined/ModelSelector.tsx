            ...
            {isLoading ? (
              ...
              visibleModels.map((model, index) => (
                <button
                  ...
                  // One line per model so more fit on screen; the description
                  // stays available as a hover tooltip.
                  title={model.description}
                  className={`flex w-full items-center gap-2 rounded-md px-2 py-1 text-left transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40 ${
