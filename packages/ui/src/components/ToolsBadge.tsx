  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-[var(--bg-surface)] text-[var(--text-control)] hover:bg-[var(--border)] transition-colors whitespace-nowrap"
      ...
      >
        ...
        <span className="text-xs">{toolCount} tools</span>
      </button>
