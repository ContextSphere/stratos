    ...
    >
      ...
      >
        <div className="p-4 space-y-4">
          ...
          {/* Cache hits — useful detail similar to what /context shows */}
          {usage.apiUsage && (
            <div className="pt-3 border-t border-[var(--border)] grid grid-cols-2 gap-y-1 gap-x-3 text-[11px]">
              ...
              <span className="text-[var(--text-muted)]">Cache writes</span>
              <span className="text-right tabular-nums text-[var(--text-primary)]">
