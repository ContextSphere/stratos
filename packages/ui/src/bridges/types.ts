...
export interface ChatBridge {
  sendMessage(threadId: string, prompt: string, images?: ImageAttachment[], sessionId?: string): void
...
export interface StreamEvent {
  type: 'message' | 'tool_call' | 'tool_result' | 'permission_request' | 'session_init' |
        'result' | 'error' | 'thinking' | 'todo_update' | 'question' | 'plan_review' |
        'thread_title' | 'thread_running' | 'thread_stopped' | 'thread_notification'
  threadId: string
